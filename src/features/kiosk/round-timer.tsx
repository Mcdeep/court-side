  ...
  return (
    <>
      <div className="hidden md:flex items-center gap-3 rounded-full bg-white/[0.06] ring-1 ring-white/10 pl-3 pr-4 h-10 shrink-0">
        ...
        <span className="text-[12px] font-bold uppercase tracking-wider text-paper/40 whitespace-nowrap">
          Round ends in
        </span>
        <span
          className={`font-mono tnum font-bold text-[18px] whitespace-nowrap ${expired ? "text-red-400 animate-pulse" : warning ? "text-amber-400" : ""}`}
        >
