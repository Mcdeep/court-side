      ...
      <div className="space-y-5 relative">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            <Marquee className="flex-1 min-w-0">
              <span
                className={`font-display text-[19px] leading-tight ${aLead ? "text-paper font-bold" : "text-paper/55 font-semibold"}`}
              >
                {nameA1}
                {nameA2 ? ` / ${nameA2}` : ""}
              </span>
          ...
          <span
            className={`font-mono tnum font-bold text-[48px] leading-none shrink-0 ${aLead ? "text-accent" : "text-paper/70"}`}
          >
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            <Marquee className="flex-1 min-w-0">
              <span
                className={`font-display text-[19px] leading-tight ${bLead ? "text-paper font-bold" : "text-paper/55 font-semibold"}`}
              >
                {nameB1}
                {nameB2 ? ` / ${nameB2}` : ""}
              </span>
          ...
          <span
            className={`font-mono tnum font-bold text-[48px] leading-none shrink-0 ${bLead ? "text-accent" : "text-paper/70"}`}
          >
