      ...
      <header className="sticky top-0 z-30 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="max-w-[1000px] mx-auto px-10 flex items-center justify-between h-14">
          <div className="flex items-center gap-2">
            <span className="w-8 h-8 rounded-lg bg-foreground text-background flex items-center justify-center font-display font-bold text-sm">
              C
            </span>
            <span className="font-display font-bold text-[17px] tracking-tight">CourtOS</span>
            <Badge variant="destructive" className="ml-1 text-[10px] font-bold uppercase">
              Admin
            </Badge>
          </div>
