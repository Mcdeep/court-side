    ...
    <ShadcnSidebar collapsible="icon" className="text-paper">
      <SidebarHeader className="border-b border-sidebar-border">
        <div className="flex items-center gap-2.5 px-1 py-1 group-data-[collapsible=icon]:justify-center">
          <span className="w-9 h-9 shrink-0 rounded-xl bg-accent text-ink flex items-center justify-center font-display font-bold text-lg">
            C
          </span>
          <span className="font-display font-bold text-[19px] tracking-tight group-data-[collapsible=icon]:hidden">
            CourtOS
          </span>
