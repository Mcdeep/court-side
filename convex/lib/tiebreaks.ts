...
export const tiebreakValidator = v.union(v.literal("points"), v.literal("wins"), v.literal("point_diff"), v.literal("head_to_head"));
...
export const TIEBREAK_LABELS = { points: "Total points", wins: "Matches won", point_diff: "Point difference", head_to_head: "Head-to-head" };
